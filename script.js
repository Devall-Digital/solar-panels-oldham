...
document.addEventListener('DOMContentLoaded', function() {
    ...
    initializeCalculator(); // Then initialize calculator (which calls updateCalculations)
...
function calculateSolarSystem() {
    ...
    // 1 kW = (1 / panelPower) panels = (1 / 0.375) = 2.67 panels
    // Area per kW = number of panels per kW × panel size
